...
# Module 2 imports
from module_2_financial_v2 import BurnAcceleration, _extract_quarterly_burns, calculate_burn_acceleration
...
class TestVolatilityInCompositeScoring:
    ...
    def test_high_volatility_reduces_weights(self, minimal_inputs):
        ...
        minimal_inputs["market_data_by_ticker"] = {"TEST": {"volatility_252d": 0.95}}  # 95% vol
        result = compute_module_5_composite_v2(**minimal_inputs)
    ...
    def test_low_volatility_boosts_weights(self, minimal_inputs):
        ...
        minimal_inputs["market_data_by_ticker"] = {"TEST": {"volatility_252d": 0.15}}  # 15% vol
        result = compute_module_5_composite_v2(**minimal_inputs)
        ranked = result["ranked_securities"][0]
    ...
    def test_volatility_diagnostic_counts(self, minimal_inputs):
        ...
        minimal_inputs["clinical_result"]["scores"] = [
            {"ticker": t, "clinical_score": "65.0", "lead_phase": "Phase 2", "severity": "none", "flags": []}
            for t in ["LOW", "MED", "HIGH", "NONE"]
        ]
...
from common.accuracy_improvements import (  # 1. Indication-specific endpoint weighting; 2. Phase-dependent staleness; 3. Regulatory pathway scoring; 4. Regime-adaptive catalyst decay; 5. Competitive landscape penalty; 6. Dynamic dilution; 7. Burn seasonality; 8. Proximity boost; Integration helper
    MarketRegimeType,
...
class TestIndicationSpecificEndpointWeighting:
    ...
    def test_oncology_os_highest_weight(self):
        ...
        weight, etype, is_strong = compute_weighted_endpoint_score(
            "Overall Survival at 5 years", TherapeuticArea.ONCOLOGY
        )
    ...
    def test_oncology_pfs_vs_orr(self):
        ...
        weight_pfs, _, _ = compute_weighted_endpoint_score("Progression-free survival", TherapeuticArea.ONCOLOGY)
        weight_orr, _, _ = compute_weighted_endpoint_score("Objective Response Rate", TherapeuticArea.ONCOLOGY)
    ...
    def test_autoimmune_acr_hierarchy(self):
        ...
        weight_70, _, _ = compute_weighted_endpoint_score("ACR70 response", TherapeuticArea.AUTOIMMUNE)
        weight_50, _, _ = compute_weighted_endpoint_score("ACR50 response", TherapeuticArea.AUTOIMMUNE)
...
class TestPhaseSpecificStaleness:
    ...
    def test_phase3_stale_after_6_months(self):
        ...
        result = compute_phase_staleness("phase 3", "2025-06-01", "2026-01-15")
    ...
    def test_phase1_not_stale_at_1_year(self):
        ...
        result = compute_phase_staleness("phase 1", "2025-01-15", "2026-01-15")
...
class TestRegulatoryPathway:
    ...
    def test_multiple_designations_additive(self):
        ...
        trial_data = {"breakthrough_designation": True, "orphan_designation": True}
        result = compute_regulatory_pathway_score(trial_data)
...
class TestRegimeAdaptiveCatalystDecay:
    ...
    def test_bull_market_faster_decay(self):
        ...
        result = compute_regime_adaptive_decay("2026-01-01", "2026-01-15", MarketRegimeType.BULL)
        assert result.decay_half_life_days == 20

    def test_bear_market_slower_decay(self):
        """Bear market should have 45-day half-life."""
        result = compute_regime_adaptive_decay("2026-01-01", "2026-01-15", MarketRegimeType.BEAR)
    ...
    def test_volatility_spike_slower_decay(self):
        ...
        result = compute_regime_adaptive_decay("2026-01-01", "2026-01-15", MarketRegimeType.VOLATILITY_SPIKE)
        assert result.decay_half_life_days == 45

    def test_sector_rotation_normal_decay(self):
        """Sector rotation should have 30-day half-life."""
        result = compute_regime_adaptive_decay("2026-01-01", "2026-01-15", MarketRegimeType.SECTOR_ROTATION)
    ...
    def test_bull_vs_bear_weight_difference(self):
        ...
        bull_result = compute_regime_adaptive_decay("2026-01-01", "2026-01-15", MarketRegimeType.BULL)
        bear_result = compute_regime_adaptive_decay("2026-01-01", "2026-01-15", MarketRegimeType.BEAR)
    ...
    def test_same_day_full_weight(self):
        ...
        result = compute_regime_adaptive_decay("2026-01-15", "2026-01-15", MarketRegimeType.BULL)
    ...
    def test_future_event_zero_weight(self):
        ...
        result = compute_regime_adaptive_decay("2026-02-01", "2026-01-15", MarketRegimeType.BULL)
...
class TestCompetitiveLandscape:
    ...
    def test_no_competitors_no_penalty(self):
        ...
        result = compute_competition_penalty("rare disease", "phase 3", [{"phase": "phase 3"}])  # 1 competitor
    ...
    def test_moderate_competition_5_points(self):
        ...
        result = compute_competition_penalty("indication", "phase 3", competitors)
    ...
    def test_first_in_class_50_percent_reduction(self):
        ...
        competitors = [{"phase": "phase 3"} for _ in range(8)]
        result = compute_competition_penalty("indication", "phase 3", competitors, is_first_in_class=True)
    ...
    def test_early_phase_50_percent_reduction(self):
        ...
        competitors = [{"phase": "phase 3"} for _ in range(8)]
        result = compute_competition_penalty("indication", "phase 1", competitors)  # Early phase
        assert result.penalty_points == Decimal("6")  # 12 * 0.5
...
class TestBurnSeasonalityAdjustment:
    ...
    def test_q1_lower_burn_adjustment(self):
        ...
        result = compute_burn_seasonality_adjustment(Decimal("10000000"), Decimal("100000000"), "2026-01-15")  # Q1
    ...
    def test_q2_higher_burn(self):
        ...
        result = compute_burn_seasonality_adjustment(Decimal("10000000"), Decimal("100000000"), "2026-04-15")  # Q2
    ...
    def test_q3_highest_burn(self):
        ...
        result = compute_burn_seasonality_adjustment(Decimal("10000000"), Decimal("100000000"), "2026-07-15")  # Q3
    ...
    def test_q4_normalized(self):
        ...
        result = compute_burn_seasonality_adjustment(Decimal("10000000"), Decimal("100000000"), "2026-10-15")  # Q4
...
class TestBinaryEventProximity:
    ...
    def test_imminent_20_percent_boost(self):
        ...
        result = compute_binary_event_proximity_boost(
            "2026-02-01", "2026-01-15", confidence="high"  # 17 days from 2026-01-15
        )
    ...
    def test_near_term_10_percent_boost(self):
        ...
        result = compute_binary_event_proximity_boost("2026-02-28", "2026-01-15", confidence="high")  # ~44 days
    ...
    def test_medium_term_5_percent_boost(self):
        ...
        result = compute_binary_event_proximity_boost("2026-03-25", "2026-01-15", confidence="high")  # ~69 days
    ...
    def test_far_no_boost(self):
        ...
        result = compute_binary_event_proximity_boost("2026-06-01", "2026-01-15")
    ...
    def test_low_confidence_reduces_boost(self):
        ...
        result_low = compute_binary_event_proximity_boost("2026-02-01", "2026-01-15", confidence="low")
