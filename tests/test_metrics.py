...
class TestTradingCalendar:
    ...
    def test_add_trading_days(self):
        # July 4, 2024 (Thu) is Independence Day — skipped as a holiday
        # Jul 1 + 5 trading days = Jul 2, 3, 5, 8, 9 → July 9
        result = add_trading_days("2024-07-01", 5)
        assert result == "2024-07-09"
            ...
            "2024-01-01": {
                "horizons": {
                    "63d": {
                        ...
                        "q5_minus_q1": "0.05",
                        "monotonic": True,
                        "bucket_metrics": {"top_minus_bottom": "0.04", "monotonic": True},
                    }
                }
            },
            "2024-02-01": {
                "horizons": {
                    "63d": {
                        ...
                        "q5_minus_q1": "0.10",
                        "monotonic": True,
                        "bucket_metrics": {"top_minus_bottom": "0.08", "monotonic": True},
                    }
                }
            },
        }
