...
from cfo_extractor import CFORecord, extract_cfo_batch, parse_xbrl_filing, prepare_for_module_2
...
def test_batch_processing():
    ...
    try:
        ...
        ticker_filings = {"CVAC": list(ticker1_dir.glob("*.txt")), "RYTM": list(ticker2_dir.glob("*.txt"))}
