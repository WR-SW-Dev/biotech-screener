...
class TestSnapshotIntegration(TestCase):
    ...
    def setUp(self):
        ...
        with open(snapshot_dir / "studies.csv", "w", newline="") as f:
            ...
            writer.writerow(
                ["NCT04470427", "Phase 2", "Recruiting", "2024-06-01", "Anticipated", "2024-01-10", "Interventional"]
            )
            writer.writerow(
                [
                    "NCT04860297",
    ...
    def test_snapshot_contains_coverage_blocks(self):
        ...
        self.assertAlmostEqual(snapshot.coverage["catalyst"]["coverage_rate"], 1 / 3, places=4)
