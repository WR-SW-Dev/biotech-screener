...
class TestSchemaValidation:
    ...
    def test_missing_studies_column_raises_error(self):
        ...
        with open(snapshot_dir / "studies.csv", "w", newline="") as f:
            ...
            )  # Missing last_update_posted_date!
            writer.writerow(["NCT00000001", "Phase 2", "Recruiting", "2024-06-01", "Anticipated", "Interventional"])
    ...
    def test_missing_sponsors_column_raises_error(self):
        ...
        with open(snapshot_dir / "studies.csv", "w", newline="") as f:
            ...
            writer.writerow(
                ["NCT00000001", "Phase 2", "Recruiting", "2024-06-01", "Anticipated", "2024-01-10", "Interventional"]
            )
...
class TestDuplicateKeyHandling:
    ...
    def test_duplicate_nct_id_keeps_latest_update(self):
        ...
        with open(snapshot_dir / "studies.csv", "w", newline="") as f:
            ...
            writer.writerow(
                ["NCT00000001", "Phase 1", "Recruiting", "2024-06-01", "Anticipated", "2024-01-05", "Interventional"]
            )
...
class TestFlagBehavior:
    ...
    def test_missing_pcd_emits_flag(self):
        ...
        with open(snapshot_dir / "studies.csv", "w", newline="") as f:
            ...
            writer.writerow(["NCT00000001", "Phase 2", "Recruiting", "", "", "2024-01-10", "Interventional"])
        ...
        provider = AACTClinicalTrialsProvider(snapshots_root=snapshots_root, compute_diffs=False)
    ...
    def test_diffs_disabled_emits_flag(self):
        ...
        provider = AACTClinicalTrialsProvider(snapshots_root=snapshots_root, compute_diffs=False)  # Explicitly disabled
        result = provider.get_trials_as_of(
            as_of_date=date(2024, 1, 31),
            pit_cutoff=date(2024, 1, 30),
            tickers=["TEST"],
    ...
    def test_diffs_unavailable_insufficient_snapshots_emits_flag(self):
        ...
        provider = AACTClinicalTrialsProvider(
            snapshots_root=snapshots_root, compute_diffs=True  # Enabled but insufficient snapshots
        )
        result = provider.get_trials_as_of(
            as_of_date=date(2024, 1, 31),
            pit_cutoff=date(2024, 1, 30),
