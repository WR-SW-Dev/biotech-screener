...
from cusip_resolver import KNOWN_CUSIP_MAPPINGS, CUSIPResolver, cusip_mapping_hash, get_resolver, resolve_cusip
...
class TestCUSIPResolverInit:
    ...
    def test_loads_existing_cache(self, temp_cache_dir):
        ...
        # Create cache file
        cache_data = {"mappings": {"TESTCUSIP": "TEST"}}
...
class TestConvenienceFunctions:
    ...
    def test_resolve_cusip_function(self, temp_cache_dir):
        ...
        cusip_resolver._default_resolver = CUSIPResolver(cache_path=None, use_openfigi=False)
