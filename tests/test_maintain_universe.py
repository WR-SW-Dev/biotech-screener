...
class TestAuditNonActive:
    ...
    def test_non_active_ticker_flagged(self, tmp_path, capsys):
        ...
        with patch.object(mu, "UNIVERSE_JSON", u_path), patch.object(mu, "SNAPSHOTS_ROOT", tmp_path / "snaps"):
            mu.cmd_audit(_args())
...
class TestAdd:
    ...
    def test_add_creates_entry(self, tmp_path):
        ...
        with patch.object(mu, "UNIVERSE_JSON", u_path), patch.object(mu, "AUDIT_LOG", log_path):
...
class TestRetireXbiBlocked:
    ...
    def test_retire_xbi_exits_nonzero(self, tmp_path):
        ...
        with (
            patch.object(mu, "UNIVERSE_JSON", u_path),
...
class TestAuditClean:
    ...
    def test_clean_universe_no_flags(self, tmp_path, capsys):
        ...
        with patch.object(mu, "UNIVERSE_JSON", u_path), patch.object(mu, "SNAPSHOTS_ROOT", tmp_path / "nosnaps"):
            mu.cmd_audit(_args())
