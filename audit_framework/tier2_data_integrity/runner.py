...
from audit_framework.tier2_data_integrity.coverage import validate_data_coverage
from audit_framework.tier2_data_integrity.failure_modes import validate_failure_modes
from audit_framework.tier2_data_integrity.provenance import validate_provenance
...
def run_tier2_audit(
    ...
    result.provenance_coverage = Decimal(prov_result.metrics.get("provenance_coverage", "0"))
    ...
    result.overall_data_coverage = Decimal(cov_result.metrics.get("overall_coverage", "0"))
    ...
    result.failure_mode_pass_rate = Decimal(failure_result.metrics.get("pass_rate", "0"))
    ...
    result.passed = result.provenance_passed and result.coverage_passed and result.failure_modes_passed
