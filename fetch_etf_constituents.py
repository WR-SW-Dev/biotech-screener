...
def main():
    ...
    parser.add_argument("--output", default="etf_constituents_universe.json", help="Output universe file")
    parser.add_argument(
        "--template-only", action="store_true", help="Create template (placeholder data) instead of fetching real data"
    )
