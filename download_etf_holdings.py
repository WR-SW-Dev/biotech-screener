...
def download_all_etf_holdings(method: str = "csv", api_key: str = None, csv_dir: Path = None) -> Dict[str, List[str]]:
    """
...
Recommended approach:
  ...
  3. Import into your universe
    ...
    parser.add_argument("--method", choices=["csv", "alphavantage", "fmp"], default="csv", help="Download method")

    parser.add_argument("--api-key", type=str, help="API key (for alphavantage or fmp methods)")

    parser.add_argument("--csv-dir", type=Path, help="Directory with downloaded CSV files (for csv method)")
    ...
    # Download holdings
    holdings = download_all_etf_holdings(method=args.method, api_key=args.api_key, csv_dir=args.csv_dir)
