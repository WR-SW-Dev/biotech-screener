...
def compute_bucket_returns(ranked_securities: List[Dict[str, Any]], returns: Dict[str, Decimal]) -> Dict[str, Any]:
    ...
    return {
        ...
        "n_buckets": n_buckets,
        "bucket_returns": {
            b: _quantize_6dp(bucket_means[b]) if bucket_means[b] is not None else None for b in range(1, n_buckets + 1)
        },
...
def compute_cohort_ic(
    ranked_securities: List[Dict[str, Any]], returns: Dict[str, Decimal], min_cohort_n: int = MIN_COHORT_N
) -> Dict[str, Any]:
...
def aggregate_metrics(all_period_metrics: Dict[str, Dict[str, Any]], horizons: List[str] = None) -> Dict[str, Any]:
    ...
    for h in horizons:
        ...
        agg = {
            ...
            "spread_mean": None,
            "spread_pos_frac": None,
            "monotonicity_rate": None,
            "bucket_spread_mean": None,
            "bucket_monotonicity_rate": None,
        }
...
def run_metrics_suite(
    module5_snapshots: List[Dict[str, Any]],
    return_provider: ReturnProvider,
    run_id: str,
    horizons: List[str] = None,
    min_cohort_n: int = MIN_COHORT_N,
    ...
    return {
        ...
        "provenance": {
            ...
            "module_ruleset_versions": sorted(ruleset_versions),
            "config_hash": config_hash,
        },
    }


def generate_attribution_frame(
    module5_snapshot: Dict[str, Any], return_provider: ReturnProvider, horizon: str
) -> List[Dict[str, Any]]:
