...
|---|---|---|---|---|
| coinvest = quality FILTER (not alpha) | (none directly; manual enforcement via code audits); agents only attribute | none — coinvest is a static gate, not an agent task | n/a | none |
