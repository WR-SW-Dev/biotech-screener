...
| Server | Status | Notes |
|---|---|---|
| `semgrep mcp` (canonical) | **E2 COMPLETE — ADMIT\_WITH\_CONSTRAINTS\_FOR\_MANUAL\_USE\_ONLY; NOT REGISTERED** | `semgrep==1.167.0`; 2-tool allowlist; 4 blockers for Hermes reg (B1–B4); workstream paused; E2: `SEMGREP_MCP_E2_ADMISSION_DECISION_2026_06_22.md` |
...
| 2026-06-22 | E2 COMPLETE: `ADMIT_WITH_CONSTRAINTS_FOR_MANUAL_USE_ONLY`; NOT REGISTERED; 4 blockers for Hermes reg (roots/list, LGPL, startup fetch, semgrep_scan broken); workstream paused |
