...
- **Root cause:** In small-cap biotech, vol surface shape is dominated by binary catalyst outcomes, not continuous information flow.
...
- **Root cause:** The options market for small-cap biotech is too thin and binary-event-driven for continuous alpha extraction.
...
- Used in institutional contexts for cash equitization
