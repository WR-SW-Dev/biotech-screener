...
| ETF | Use | Level (May 18) |
| --- | --- | --- |
| XBI | SPDR S&P Biotech ETF (equal-weight small/mid cap) | $130.69 (-2.98% week of May 12; ASCO rally late May brought recovery) |
...
1. Architecture freeze LIFTED 2026-05-26 — regime-conditional scoring evaluation is now unblocked. Follow the recommended sequence above before any production integration.
