...
- **Clamp**: `execution_score = clamp(execution_score, 0, 22)`

> **Production state (commit 3ad7b904, merged 2026-05-18):** Base remains 12, true max = 12 + 10 - 0 = 22. The normalization denominator in Step 14 was corrected from 120 to 117 to match this actual maximum. clinical_score ceiling is now 100.0.
