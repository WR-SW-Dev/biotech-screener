...
> **Fix applied 2026-05-16 (Code Review M2):** Added zero-guard for avg_daily_volume and share_price. Previously, halted stocks (volume=0) or zero-priced securities would cause a ZeroDivisionError in days_to_raise.
