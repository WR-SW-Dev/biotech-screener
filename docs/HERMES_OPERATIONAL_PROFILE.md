...
**Status:** Phase 2 operational (2026-06-05; repo audit refreshed 2026-06-19)
**Repo Hermes skills:** 32 registered docs in `docs/hermes_skills/_meta.json`; 19 Cursor mirrors in sync  
**Repo agent fleet:** 34 registry entries: 29 active, 1 suppressed, 4 deprecated; 31 agent directories on disk
...
**Repo audit (2026-06-19):** 32 Hermes skill docs registered in `_meta.json`; no mirror drift across cursor-synced skills. The operational layer inventory below is a conceptual operator-host profile, not the authoritative repo skill count.
