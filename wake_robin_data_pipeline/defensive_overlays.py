...
def enrich_universe_with_defensive_overlays(
    ...
    for sec in records:
        ...
        sec["defensive_features"] = {k: (str(v) if v is not None else None) for k, v in feats.items()}
...
if __name__ == "__main__":
    ...
    # Compute features
    feats = compute_defensive_features(sample_sec["time_series"], sample_xbi["time_series"])
