...
def generate_mock_yahoo_data(ticker: str) -> dict:
    ...
    return {
        ...
        "market_cap": {"value": int(market_cap), "currency": "USD"},
        "shares_outstanding": int(market_cap / base_price),
        "volume": {"last": random.randint(100000, 5000000), "average_30d": random.randint(500000, 3000000)},
        "valuation": {
        ...
        "company_info": {"name": f"{ticker} Pharmaceuticals Inc.", "sector": "Healthcare", "industry": "Biotechnology"},
        "provenance": {
...
def generate_mock_trials_data(ticker: str, company_name: str) -> dict:
    ...
    if has_trials:
        ...
        phase_dist = {
            phase: random.randint(0, num_trials // 2) for phase in random.sample(phases, k=random.randint(1, 3))
        }

        lead_stage_map = {"PHASE4": "commercial", "PHASE3": "phase_3", "PHASE2": "phase_2", "PHASE1": "phase_1"}
        ...
        return {
            ...
            "summary": {
                ...
                "by_phase": phase_dist,
                "by_status": {"RECRUITING": active_trials, "COMPLETED": num_trials - active_trials},
        ...
        return {
            ...
            "success": True,
            "trials": [],
            "summary": {"total_trials": 0, "active_trials": 0, "completed_trials": 0, "lead_stage": "unknown"},
            "provenance": {"source": "MOCK DATA (Demo Mode)", "timestamp": datetime.now().isoformat()},
            "from_cache": False,
        }
