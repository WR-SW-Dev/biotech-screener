...
def expand_universe(
    universe_path: Path, output_path: Path, include_xbi: bool = True, include_ibb: bool = True, include_nbi: bool = True
) -> dict:
    """
...
Note:
  ...
  Run collect_universe_data.py afterward to fetch full data.
    ...
    parser.add_argument("--universe", type=Path, required=True, help="Path to current universe.json")

    parser.add_argument("--output", type=Path, help="Path for expanded universe (default: universe_expanded.json)")

    parser.add_argument("--xbi-only", action="store_true", help="Only add XBI constituents")

    parser.add_argument("--ibb-only", action="store_true", help="Only add IBB constituents")

    parser.add_argument("--nbi-only", action="store_true", help="Only add NBI constituents")

    parser.add_argument("--dry-run", action="store_true", help="Preview changes without writing file")
