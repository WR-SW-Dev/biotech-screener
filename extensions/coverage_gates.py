...
def calculate_coverage_confidence(
    ...
    mod4 = security_record.get("module_4_clinical_dev", {}) or security_record.get("module_4_clinical", {}) or {}
    ...
    if inst:
        ...
        inst_present, inst_total, inst_missing = (
            0,
            len(REQUIRED_FIELDS["institutional"]),
            list(REQUIRED_FIELDS["institutional"]),
        )
