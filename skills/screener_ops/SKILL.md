...
- **Registry**: 34 agents \(31 active, 2 deprecated, 1 shadow\) + 4 Hermes governance jobs in `agents/` \(held-spec, first-fire, ruleset-integrity, contradiction-detector\) — see `agents/AGENT_REGISTRY.json`
