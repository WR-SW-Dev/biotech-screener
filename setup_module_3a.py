...
def verify_data_schema():
    ...
    try:
        ...
        required_fields = ["ticker", "nct_id", "status", "last_update_posted"]
...
def run_quick_test():
    ...
    try:
        from ctgov_adapter import AdapterConfig, process_trial_records_batch
        ...
        canonical_records, stats = process_trial_records_batch(test_records, date.today(), config)
