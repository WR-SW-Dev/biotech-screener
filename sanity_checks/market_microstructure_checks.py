...
class MarketMicrostructureChecker:
    ...
    def _check_conference_calendar(
        ...
        upcoming_major = [c for c in conferences if c.conference_tier == "major"]
        ...
        for conf in upcoming_major:
            ...
            if expected_indication and expected_indication not in ("general",):
                ...
                has_representation = any(expected_indication.lower() in ind.lower() for ind in top20_indications.keys())
    ...
    def _check_sentiment_divergence(
        ...
        for ticker, ticker_ratings in ratings_by_ticker.items():
            ...
            recent_upgrades = [
                r
                for r in ticker_ratings
                if r.prior_rating
                and r.prior_rating.lower() in ("hold", "neutral", "sell")
