...
class DomainExpertChecker:
                    ...
                    flags.append(
                        SanityFlag(
                            ...
                            details={
                                ...
                                "deal_value_mm": (
                                    float(partnership.deal_value_mm) if partnership.deal_value_mm else None
                                ),
    ...
    def _calculate_metrics(
        ...
        by_check = {check: sum(1 for f in flags if check in f.check_name) for check in check_types}
