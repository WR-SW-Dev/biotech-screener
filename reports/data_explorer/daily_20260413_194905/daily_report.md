...
**Generated:** 2026-04-13 19:49 UTC
...
- **N:** 30
- **Overlap:** 26 (86.7%)
- **Added:** 4 — AXSM, RYTM, SION, ZYME
- **Removed:** 4 — ANNX, KYMR, SLDB, SRRK
...
| --- | --- | --- | --- | --- |
| COGT | inst_delta_z | 3.6463 | 0.0 | -3.6463 |
| CMPX | inst_delta_z | 3.6463 | 0.0 | -3.6463 |
| EWTX | inst_delta_z | 3.0194 | 0.0 | -3.0194 |
| RNA | inst_delta_z | 2.706 | 0.0 | -2.706 |
| INSM | inst_delta_z | -2.3091 | 0.0 | 2.3091 |
| RCUS | inst_delta_z | 2.0791 | 0.0 | -2.0791 |
| SLDB | inst_delta_z | 2.0791 | 0.0 | -2.0791 |
| ANNX | inst_delta_z | 2.0791 | 0.0 | -2.0791 |
| TECX | inst_delta_z | 2.0791 | 0.0 | -2.0791 |
| BCRX | inst_delta_z | 2.0791 | 0.0 | -2.0791 |
| VRDN | inst_delta_z | 2.0791 | 0.0 | -2.0791 |
| ARVN | inst_delta_z | -1.9957 | 0.0 | 1.9957 |
| IONS | inst_delta_z | -1.9957 | 0.0 | 1.9957 |
| LRMR | inst_delta_z | -1.9957 | 0.0 | 1.9957 |
| LQDA | inst_delta_z | -1.9957 | 0.0 | 1.9957 |
| COGT | clinical_score_v2_z | -0.3748 | -1.3288 | -0.954 |
| VRDN | clinical_score_v2_z | -0.2826 | -1.1633 | -0.8807 |
| SLDB | final_score | 0.641 | 0.0001 | -0.641 |
| ANNX | final_score | 0.6398 | 0.0001 | -0.6398 |
...
### EXPRESSION
- `expression_overlay_summary.json` (0.8 KB) — Expression overlay summary
- `expression_recommendations.json` (55.2 KB) — Tradeable recommendations
...
- `snapshot_manifest.json` (7.5 KB) — Snapshot manifest
...
- `institutional_summary.json` (142.2 KB) — 
- `institutional_summary_delta.json` (71.0 KB) — 
- `long_call_candidates.csv` (34.3 KB) — 
- `long_call_candidates.json` (184.1 KB) — 
- `long_call_candidates.md` (49.9 KB) — 
...
- `options_review_queue.csv` (10.6 KB) — 
- `options_review_queue.json` (40.8 KB) — 
...
- `review_queue.csv` (22.0 KB) — 
- `review_queue.md` (13.5 KB) — 
- `screen_output.json` (12644.4 KB) — 
- `trapops_daily_summary.json` (7.3 KB) — 

### RANKINGS
- `rankings.csv` (613.4 KB) — Main ranked universe
