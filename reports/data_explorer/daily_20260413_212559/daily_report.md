...
**Rows:** 297 | **Columns:** 280
**Generated:** 2026-04-13 21:26 UTC
...
- Common columns: 272
- Only in B: calendar_confidence, catalyst_date_lower, catalyst_date_precision, catalyst_date_upper, catalyst_source_filed_at, has_catalyst_signal.1, has_tradeable_calendar, next_catalyst_date
...
- `snapshot_manifest.json` (9.8 KB) — Snapshot manifest
...
- `event_premium_decomp.json` (18.5 KB) — 
...
- `long_call_candidates.md` (49.8 KB) — 
- `metadata.json` (67.7 KB) — 
...
- `options_quality_manifest.json` (125.7 KB) — 
