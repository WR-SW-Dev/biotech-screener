...
def main():
    ...
    try:
        ...
        results.append(
            ("Market Data", run_collection("collect_market_data.py", "Market Data Collection (Yahoo Finance)"))
        )
        ...
        results.append(
            (
                "Clinical Trials",
                run_collection("collect_ctgov_data.py", "Clinical Trials Collection (ClinicalTrials.gov)"),
            )
        )

        # Collection 3: Financial Data (slowest)
        results.append(
            ("Financial Data", run_collection("collect_financial_data.py", "Financial Data Collection (SEC EDGAR)"))
        )
