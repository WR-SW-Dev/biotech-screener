...
from backtest.metrics import HORIZON_DISPLAY_NAMES, generate_attribution_frame, run_metrics_suite
...
def run_backtest():
    ...
    for row in frame[:5]:
        ...
        print(f"    {row['ticker']:6s} | Score: {row['composite_score']:>6s} | " f"Q{row['quintile']} | Return: {ret}")
