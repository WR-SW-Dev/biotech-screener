...
from backtest.data_readiness import SchemaValidationError, validate_and_load_csv
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Sync Sharadar SEP data from Nasdaq Data Link")
    parser.add_argument("--full", action="store_true", help="Full rebuild (slow, clears existing data)")
    parser.add_argument("--days", type=int, help="Sync last N days")
    parser.add_argument("--start-date", default="2015-01-01", help="Start date for full sync (YYYY-MM-DD)")
    parser.add_argument("--tickers", help="Comma-separated list of tickers to filter")
