...
class AblationReport:
    ...
    def to_dict(self) -> dict:
        ...
        return {
            "metadata": {
                ...
                "n_variants": len(self.runner.variants),
                "fixture_provenance": (
                    self.runner.fixture_provenance.to_dict() if self.runner.fixture_provenance else None
                ),
            },
            "variants": [
                {
            ...
            "summary_stats": {name: stats.to_dict() for name, stats in self.all_stats.items()},
    ...
    def print_summary(self):
        ...
        for name in [
            ...
            print(
                f"{name:<20} {stats.mean_adjusted_pos:>10.4f} {stats.median_adjusted_pos:>10.4f} "
        ...
        for name, stats in self.all_stats.items():
            ...
            partial = stats.lookup_distribution.get("partial_indication", 0) + stats.lookup_distribution.get(
                "partial_mechanism", 0
            )
