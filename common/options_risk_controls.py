...
Three defensive controls for very near-term binary events:
...
All controls are suppressed when options data is stale.
...
def compute_0_30_risk_controls(
    ...
    Returns:
        Dict with crowding_flag, complacency_flag, gap_risk_cap_reduction,
        hard_cap_multiplier, review_required, control_reasons.
    """
    result: Dict[str, Any] = {
        "crowding_flag": False,
    ...
    if result["crowding_flag"] or result["complacency_flag"]:
        result["review_required"] = True
