...
HELD_ITEMS_SEED = [
    {
        ...
        "last_evidence": "B1b FORMALLY PASSED 2026-05-14 (artifacts/audit/spec_087_b1b_formal_closure_2026_05_14.md). B2 now unblocked.",
        "blocker": None,
        "next_allowed_action": "Draft dashboard staleness banner spec; design freshness indicator and refresh timing",
        "not_allowed": [
            "imply hedge_report data is alpha-generating",
            "dashboard code changes before B2 spec is approved",
        ],
        "requires_operator_approval": True,
        "related_artifacts": [
            "artifacts/audit/spec_087_b1b_formal_closure_2026_05_14.md",
        ],
        "related_cron": None,
    ...
    },
    {
        ...
        "status": "HELD",
        "last_evidence": "B1b PASSED 2026-05-14. 087C unblocked from B1b. Latest hedge report: 2026-06-02. Cron fires Fridays 8 AM ET.",
        "blocker": "Need ≥4 fresh weekly hedge reports. Currently have ~1-2 reports. Expect 2+ more by ~2026-06-30 to reach threshold.",
        "next_allowed_action": "Phase A research design only — monitor report accumulation; no implementation until 4+ reports available",
        "not_allowed": [
        ...
        "requires_operator_approval": True,
        "related_artifacts": [
            "artifacts/audit/spec_087c_phase_a_research_design_2026_05_14.md",
        ],
        "related_cron": "0 8 * * 5  # biotech_hedge_report.py",
        "alert_condition": "When fresh report count reaches ≥4, NEEDS_OPERATOR_DECISION on 087C implementation approval",
    },
    {
